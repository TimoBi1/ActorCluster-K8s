...
public class PrimeClusterMasterActor extends AbstractActor implements ConstantMessages {
	...
	private List<SegmentMessage> availableSegments = new ArrayList<SegmentMessage>();
	private final List<Long> primeResults = new ArrayList<Long>();
...
//	private static final int SEGMENT_COUNT = 500;
   ...
   public PrimeClusterMasterActor() {
	 ...
	 * 
	 */
	public void handlePrimeResultReceived(PrimeResult result) throws FileNotFoundException, InterruptedException {
		// print highest prime number and number of primes yet
		primeResults.addAll(result.getResults());
		// hchste primzahl und Anzahl der Primzahlen ausgeben
